...
function detectProjectRoot() {
    ...
    let dir = process.cwd();
    for (let i = 0; i < 10; i++) {
        if ((0, fs_1.existsSync)((0, path_1.join)(dir, 'toongine.config.json')))
            return dir;
